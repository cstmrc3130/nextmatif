    ...
    return (
        <div className="container h-full flex flex-col justify-between gap-y-0 lg:grid lg:grid-cols-12 lg:gap-4 mx-auto ">
            <div className="self-center mt-20 lg:mb-0 lg:col-span-7">
                ...
                <motion.div className={`m-0 h-1 bg-[#fecc0d] w-1/4 mt-2 mb-6`} initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.6 }} viewport={{ once: true }}></motion.div>
