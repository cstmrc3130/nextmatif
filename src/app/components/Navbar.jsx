  ...
  export default function Navbar() {
    ...
    return (
      <div className="border border-stone-800/90 p-[0.4rem] rounded-lg mb-12 sticky top-0 z-[100] bg-stone-900/80 backdrop-blur-md">
        <nav className="flex gap-2 relative justify-between w-full z-[100]  rounded-lg">
          ...
          <div>{navItems.map((item, index) => {
            ...
            return (
              <Link
                key={item.path}
                className={`top-4 px-4 py-2 rounded-md text-sm lg:text-base relative no-underline duration-300 ease-in ${
